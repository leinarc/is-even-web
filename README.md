...
Tests if a number is odd or even using if statements

Inspired by [this](https://andreasjhkarlsson.github.io/jekyll/update/2023/12/27/4-billion-if-statements.html)

The main challenge in writing this is making the HTML file and script as short as possible
...
- Using `c==0?1:c==1?0:c==2?1:0` triggers max recursion limit xd
...
The highest I was able to do was 2^25